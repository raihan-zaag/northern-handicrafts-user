...
const VerificationForm = ({ title, verifyShortForm, handleUpdate }) => {
  ...
  <div className="w-full max-w-330px sm:max-w-500px flex flex-col pt-6 px-4 pb-9 md:pt-4 md:px-12 md:pb-12 shadow-light-grey bg-secondary border border-border mb-16">
  <h1 className="flex w-full justify-center font-semibold text-xl text-neutral-700 py-3 border-b border-gray-blue/10">
      ...
      classNames={{
              ...
              character:
        "w-43px h-41px md:w-12 md:h-12 text-md2 md:text-base text-gray-dark2 flex items-center justify-center leading-18px md:leading-20px bg-white rounded-sm border border-border-input ",
