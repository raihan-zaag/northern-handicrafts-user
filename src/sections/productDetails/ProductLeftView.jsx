            ...
            >
              ...
              >
                <Image
                  ...
                  } rounded-sm object-fit bg-bg-light-gray`}
                />
              </div>
            </div>
          ))}
          ...
          >
            {[data.thumbnailImage, ...images].map((item, index) => (
              <div
                ...
                // }`}
        className={`flex justify-center items-center border border-border-gray overflow-hidden ${
                  forModal
          ? ""
          : "w-360px md:w-280px md:h-300px lg:w-380px lg:h-400px xl:w-412px xl:h-513px 2xl:w-564px 2xl:h-664px"
                } `}
                ...
                <Image
                  ...
                  className={`${
                    forModal
                      ...
                      : "w-360px  lg:w-380px lg:h-400px xl:w-540px xl:h-450px 2xl:w-564px 2xl:h-664px"
                  } w-full  rounded-sm object-fit bg-bg-light-gray`}
                />
              </div>
            ))}
          </Carousel>
